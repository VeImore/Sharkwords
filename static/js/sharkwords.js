...
const generateLetterButtons = (button) => {
  const generateButton = document.querySelector("#letter-buttons")
  for (const button of 'abcdefghijklmnopqrstuvwxyz') {
    generateButton.insertAdjacentHTML(
      'beforeend',
      
      `<button id="letter-buttons ${button}"></button>`);
  }
};
